...
namespace Api.Insttantt.Controllers
{
    ...
    [ApiController]
    public class UsersController : BaseController<Entities.Users, BusinessRules.Interfaces.IUsers>
    {
        public UsersController(BusinessRules.Interfaces.IUsers repoBusinessRules) : base(repoBusinessRules)
        {

        }

        /// <summary>
        /// Get an entity Users by Id
        /// </summary>
        /// <param name="id"></param>
